...
public class DError extends javax.swing.JDialog {
    ...
    public DError(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        labMensaje.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/r_ico_error_64.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DError dialog = new DError(new javax.swing.JDialog(), true);
