 ...
 * @author rodka
 */
public class MCInformeInventario implements ComboBoxModel {

    private List<OCatArticulos> catArticulos;
    private String Nombre = "Seleccione Categoria";

    public MCInformeInventario(List<OCatArticulos> catArticulos) {
        this.catArticulos = catArticulos;
    }

    public List<OCatArticulos> getCategorias() {
        return catArticulos;
    }
